                ...
                <div className="section__my-apresentation">
                    ...
                    <Reveal delay={0.6}>
                        <p className="my-apresentation__about">
                            <Trans i18nKey="apresentation.about_html">
                                Desenvolvedor Full Stack com foco em construir aplicações robustas
                                e escaláveis — do backend com <strong>Java / Spring Boot</strong> ao
                    ...
                    <Reveal delay={0.75}>
                        <div className="hero__cta-row">
                            ...
                            >
                                {t('apresentation.see_projects')} <FaArrowRight className="btn-icon" />
                            </a>
                            <a
